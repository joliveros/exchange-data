...
from ._tick import Bid, Ask, Trade
...
class Book(object):
    ...
    def bid_split(self, id_num, qty, price, timestamp):
        data = {
            'timestamp': timestamp,
            'qty': qty,
            'price': price,
    ...
    def ask_split(self, id_num, qty, price, timestamp):
        data = {
            'timestamp': timestamp,
            'qty': qty,
            'price': price,
    ...
    def trade_split(self, qty, price, timestamp):
        data = {
            'timestamp': timestamp,
            'qty': qty,
            'price': price,
