    ...
    def _run(self, trial: Trial):
        ...
        hparams = dict(
            positive_change_quantile=trial.suggest_float(
                'positive_change_quantile', 0.27, 0.55),
            negative_change_quantile=trial.suggest_float(
                'negative_change_quantile', 0.53, 0.75),
            flat_ratio=trial.suggest_float('flat_ratio', 0.48, 0.60),
            #interval=trial.suggest_int('interval', 4, 12),
            learning_rate=trial.suggest_float('learning_rate', 0.036, 0.042),
            #lstm_units=trial.suggest_int('lstm_units', 4, 18)
