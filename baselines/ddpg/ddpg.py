...
def learn(network, env,
    ...
    network_kwargs['batch_size'] = batch_size
    memory = Memory(limit=int(memory_limit), action_shape=env.action_space.shape, observation_shape=env.observation_space.shape)
